...
// let isDev: boolean;  // 이제 isDev는 boolean 타입이 됩니다.

// async function initializeApp() {
//   // 비동기적으로 모듈 로드
//   const devCheck = await import('electron-is-dev');
//   isDev = devCheck.default;  // electron-is-dev의 default export가 boolean 값을 갖고 있습니다.
//
